...
const locations = [
    {
        ...
        descricao: "Desfrute de um paraíso tropical em nossa pousada! Relaxe em nossas piscinas com vista para o mar.",
        local: "RJ",
        imagem: {
    ...
    },
    {
        ...
        descricao: "Conecte-se com a natureza em Arraial do Cabo! Nossa pousada está localizada próximo às praias.",
        local: "RJ",
        imagem: {
            uri: "/Assets/Images/praia.jpg",
            descricao: "Imagem de praia.",
    ...
    {
        titulo: "Treze Tílias",
        descricao: "Viva a experiência de um vilarejo europeu no Brasil! Nossa pousada em Treze Tílias é perfeita.",
        local: "SC",
        imagem: {
            uri: "/Assets/Images/praia.jpg",
            descricao: "Imagem de praia.",
    ...
    {
        titulo: "Ipanema",
        descricao: "Explore a rica cultura e história de Ipanema! Nossa pousada é o ponto de partida ideal para conhecer.",
        local: "RJ",
        imagem: {
            uri: "/Assets/Images/praia.jpg",
            descricao: "Imagem de praia.",
